...
interpret.types = types;
interpret.toParts = toParts;

function namespace ()/*: FormatMessage */ {
    var formats = Object.assign({}, origFormats)
    ...
    formatMessage.setup = function setup (opt/*:: ?: Options */) {
      ...
      if (opt.formats) {
        if (opt.formats.number) Object.assign(formats.number, opt.formats.number)
        if (opt.formats.date) Object.assign(formats.date, opt.formats.date)
        if (opt.formats.time) Object.assign(formats.time, opt.formats.time)
      }
      if (opt.types) {
        types = opt.types
        types[tagsType] = richType
